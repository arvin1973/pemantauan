        ...
        <div class="col-lg-12">
            <div class="page-title-box" style="padding-bottom: 0px; margin-left: 0px; margin-right: 0px;">
                ...
                <div class="card card-fill" style="border: 1px solid #000000; border-radius: 20px; display: inline-block; background-color: white">
                    <h4 class="card-title text-black" style="font-family: 'Montserrat', sans-serif; padding: 0.5rem 0.75rem;">Pencapaian Indikator Makro</h4>
                </div>
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="grafik-b2" role="tabpanel" aria-labelledby="grafik-b2-tab">
