...
<h4 class="page-title ml-3"><img class="chart-icon" src="<?php echo base_url("assets/images/chart-line-icon.png")?>"> Indeks pembangunan manusia</h4>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-graph" role="tabpanel" aria-labelledby="nav-graph-tab">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="display: none; padding: 0px;" id="pe_pro">
                        <div class="card card-box" style="border: 2px solid black;" id="pe_pro">
                            <div class="card-body" >
